---
title: Setup Guide
description: Get docdrift.yaml and GitHub workflows in place with Manual or Devin PR.
---
...
- See [Configuration](/guides/configuration) for modes and spec providers
- See [Configuration Reference](/deepwiki/pages/detection-rules) for full `docdrift.yaml` schema
