...
description: Docdrift supports OpenAPI3, FastAPI, Fern, GraphQL, Mintlify, and more.
---
...
For end-to-end flows and command usage, see [Real World Scenarios](/real-world-scenarios).
