...
5. **Commit-to-branch** (default on pull request): Devin commits to the source PR branch; no separate docdrift PR. Optional **separate-pr**: create/update `docdrift/pr-{N}` PR
